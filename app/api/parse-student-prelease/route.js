...
import { parseStudentPrelease } from '@/lib/student-prelease-parser'
...
export async function POST(request) {
  ...
  try {
    ...
    const parsed = parseStudentPrelease(buffer)
    ...
    return NextResponse.json({ success: true, period: parsed.period, property: parsed.property, floorplans: parsed.floorplans.length })
  } catch (err) {

...
export function parseHelloData(buffer) {
  ...
  // Subject column sits between "Property Name" and "Comps Avg" — skip it dynamically
  ...
  hdr.forEach((v, ci) => {
    ...
    if (propNameCi >= 0 && compsAvgCi >= 0 && ci > propNameCi && ci < compsAvgCi) return

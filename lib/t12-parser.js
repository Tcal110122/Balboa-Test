...
function parseT12Data(grid) {
  ...
  const totalIncome  = fig('49999-999', 'Total Income',            /^(total (income|revenue)|effective gross income|egi|total revenue|income)\s*$/i)
  ...
  // Prefer actual "Other Income" row; only derive when it doesn't exist

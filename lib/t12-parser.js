...
function parseT12Data(grid) {
  ...
  const expenseCats = [
    ['51599-099', 'Payroll & Benefits',       /^(total )?payroll\s*$/i],
    ['53999-099', 'General Maintenance',      /^(total )?(general maintenance|repairs? & maint)\s*$/i],
    ['54999-099', 'Advertising / Marketing',  /^(total )?(advertising|marketing)\s*$/i],
    ['58399-099', 'General & Administrative', /^(total )?general.{0,5}admin\s*$/i],
    ['59999-099', 'Utilities',                /^(total )?utilities\s*$/i],
    ['61999-099', 'Management Fees',          /^(total )?management fee\s*$/i],
    ['62999-099', 'Taxes',                    /^(total )?taxes?\s*$/i],
